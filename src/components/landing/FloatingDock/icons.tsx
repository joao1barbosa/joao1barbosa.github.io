...
/* Ícones SVG inline (sem dependências externas). viewBox preservado do design original. */
...
export function ProjectsIcon({className}: IconProps): ReactNode {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      <path d="M4.825 12.025L8.7 15.9q.275.275.275.7t-.275.7q-.275.275-.7.275t-.7-.275l-4.6-4.6q-.15-.15-.213-.325T2.426 12q0-.2.063-.375T2.7 11.3l4.6-4.6q.3-.3.713-.3t.712.3q.3.3.3.713t-.3.712l-3.9 3.9Zm14.35-.05L15.3 8.1q-.275-.275-.275-.7t.275-.7q.275-.275.7-.275t.7.275l4.6 4.6q.15.15.213.325t.062.375q0 .2-.063.375t-.212.325l-4.6 4.6q-.3.3-.7.288t-.7-.313q-.3-.3-.3-.712t.3-.713l3.875-3.875Z" />
    </svg>
  );
}

export function HighlightsIcon({className}: IconProps): ReactNode {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      <path d="M13.6 14L11 11.4l-5 5L8.6 19l5-5Zm-1.175-4.025l2.6 2.6L20 7.6L17.4 5l-4.975 4.975Zm-2.1-.7l5.4 5.4L10 20.4q-.6.6-1.4.6t-1.4-.6l-.05-.05l-.075.075q-.275.275-.638.425t-.762.15H2.7q-.35 0-.475-.3t.125-.55l2.3-2.3l-.05-.05q-.6-.6-.6-1.4t.6-1.4l5.725-5.725Zm0 0L16 3.6q.6-.6 1.4-.6t1.4.6l2.6 2.6q.6.6.6 1.4T21.4 9l-5.675 5.675l-5.4-5.4Z" />
    </svg>
  );
}

export function BlogIcon({className}: IconProps): ReactNode {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
export function NotebookIcon({className}: IconProps): ReactNode {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      <path d="M6 22q-.825 0-1.413-.588T4 20V4q0-.825.588-1.413T6 2h9l5 5v13q0 .825-.588 1.413T18 22H6Zm0-2h12V8h-4V4H6v16Zm2-2h8v-2H8v2Zm0-4h8v-2H8v2Zm6-7V4v3Z" />
    </svg>
  );
}
...
export function LinkedinIcon({className}: IconProps): ReactNode {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
...
export function XIcon({className}: IconProps): ReactNode {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
